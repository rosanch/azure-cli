...
def connected_registry_list_output_format(result):
    return _output_format(result, _connected_registry_list_format_group)
...
def _connected_registry_format_group(item): #TODO
    return OrderedDict([
        ('NAME', _get_value(item, 'name')),
        ('STATUS', _get_value(item, 'status')),
...
def _connected_registry_list_format_group(item): #TODO
    return OrderedDict([
        ('NAME', _get_value(item, 'name')),
        ('STATUS', _get_value(item, 'status')),
        ('PARENT', _get_value(item, 'parent')),
